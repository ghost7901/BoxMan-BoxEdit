...
public:
	...
	BOOL Stretch(CDC *pDC,CPoint ptDest,CSize szDest,CPoint ptSrc,CSize szSrc,DWORD dwRop);
//	BOOL DrawDib(CDC *pDC,CPoint ptDest,CSize szDest,CPoint ptSrc,CSize szSrc,DWORD dwRop);
	...
	BOOL ImageLoad(const char *lpszPathName,CDC *pDC);
